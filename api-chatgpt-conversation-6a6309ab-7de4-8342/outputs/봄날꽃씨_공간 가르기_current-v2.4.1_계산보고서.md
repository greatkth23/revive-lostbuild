...
- 중간 버림 단계: `없음`
- API 원본: [봄날꽃씨_공간 가르기_current-v2.4.1_api_raw.json](봄날꽃씨_공간 가르기_current-v2.4.1_api_raw.json)
- 파싱 결과: [봄날꽃씨_공간 가르기_current-v2.4.1_parsed.json](봄날꽃씨_공간 가르기_current-v2.4.1_parsed.json)
...
| 아크그리드 코어 질서의 해 코어 : 비연참 10P skillDamagePercent | `0.02` | `arkGrid.Slots[0].Tooltip.options[0]`<br>우산 스킬의 피해량이 2.0% 증가한다.<br>현재 18P/고대; 연산자=MULTIPLY; UMBRELLA_SKILL 태그 필요 | 예 | 아니오 | 아니오 | UMBRELLA_SKILL 태그 필요 |
...
| 아크그리드 코어 질서의 해 코어 : 비연참 17P skillDamagePercent | `0.01` | `arkGrid.Slots[0].Tooltip.options[2]`<br>'운명' 발동 시 4.0초 동안 지속되는 기류 보호막이 생성된다. 우산 스킬의 피해량이 1.0% 증가한다.<br>현재 18P/고대; 연산자=MULTIPLY; UMBRELLA_SKILL 태그 필요; 기류 보호막 보유(최대 유리 조건) | 예 | 아니오 | 아니오 | UMBRELLA_SKILL 태그 필요 |
| 아크그리드 코어 질서의 해 코어 : 비연참 18P skillDamagePercent | `0.002` | `arkGrid.Slots[0].Tooltip.options[3]`<br>우산 스킬의 피해량이 0.2% 증가한다.<br>현재 18P/고대; 연산자=MULTIPLY; UMBRELLA_SKILL 태그 필요 | 예 | 아니오 | 아니오 | UMBRELLA_SKILL 태그 필요 |
...
| 아크그리드 코어 질서의 달 코어 : 우산의 춤 10P skillDamagePercent | `0.02` | `arkGrid.Slots[1].Tooltip.options[0]`<br>우산 스킬의 피해량이 2.0% 증가한다.<br>현재 18P/유물; 연산자=MULTIPLY; UMBRELLA_SKILL 태그 필요 | 예 | 아니오 | 아니오 | UMBRELLA_SKILL 태그 필요 |
...
| 아크그리드 코어 질서의 달 코어 : 우산의 춤 18P skillDamagePercent | `0.002` | `arkGrid.Slots[1].Tooltip.options[3]`<br>우산 스킬의 피해량이 0.2% 증가한다.<br>현재 18P/유물; 연산자=MULTIPLY; UMBRELLA_SKILL 태그 필요 | 예 | 아니오 | 아니오 | UMBRELLA_SKILL 태그 필요 |
...
|---|---:|---:|---|---:|---|---|---|
| 질서의 해 코어 : 비연참 (고대) | 18 | 10P | `skillDamagePercent` | 0.02 | `MULTIPLY` | 아니오 | UMBRELLA_SKILL 태그 필요 |
| 질서의 해 코어 : 비연참 (고대) | 18 | 14P | `skillDamagePercent` | 0.05 | `MULTIPLY` | 아니오 | 대상 스킬: 회오리 걸음, 몰아치기, 바람송곳, 칼바람; 운명 효과 활성(최대 유리 조건) |
| 질서의 해 코어 : 비연참 (고대) | 18 | 17P | `skillDamagePercent` | 0.01 | `MULTIPLY` | 아니오 | UMBRELLA_SKILL 태그 필요; 기류 보호막 보유(최대 유리 조건) |
| 질서의 해 코어 : 비연참 (고대) | 18 | 18P | `skillDamagePercent` | 0.002 | `MULTIPLY` | 아니오 | UMBRELLA_SKILL 태그 필요 |
| 질서의 달 코어 : 우산의 춤 (유물) | 18 | 10P | `skillDamagePercent` | 0.02 | `MULTIPLY` | 아니오 | UMBRELLA_SKILL 태그 필요 |
| 질서의 달 코어 : 우산의 춤 (유물) | 18 | 17P | `skillDamagePercent` | 0.08 | `MULTIPLY` | 아니오 | 대상 스킬: 회오리 걸음, 몰아치기 |
| 질서의 달 코어 : 우산의 춤 (유물) | 18 | 18P | `skillDamagePercent` | 0.002 | `MULTIPLY` | 아니오 | UMBRELLA_SKILL 태그 필요 |
...
`최종 공격력 원시값 = 209582.7284128795624445623852066347519600 × (1 + 0.1495) = 240915.3463106050570300244617950266473780`

`규칙 적용 최종 공격력 = 240915.3463106050570300244617950266473780`

API 프로필 공격력은 `217160`이며 계산값과의 차이는 `23755.3463106050570300244617950266473780`입니다.
...
`전체 소제목 배율 = 1.24 × 1.19 × 1.17 × 1.625440 × 1.070 × 1.15 × 1.184 × 3.0 × 1.012 × 1.045 × 1 × 1 × 1.0728 × 1.020 × 1.0016 × 1.0016 × 1.025 × 1.0016 × 1.0016 × 1.0016 × 1 = 14.66530875184573671383848465296245211093`
...
`비치명타 원시값 = 29026461.20 × 1.5348 × 14.66530875184573671383848465296245211093 × 0.76 × 0.5263157894736842105263157894736842105263 = 261334702.9382452952809152707352225090839`

`floor(261334702.9382452952809152707352225090839) = 261,334,702`
...
`치명타 원시값 = 261334702.9382452952809152707352225090839 × 2.596 × 1.155557200 = 783958764.9440307144274559749341405836764`

`기대 피해 원시값 = 783958764.9440307144274559749341405836764 × 0.9576 + 261334702.9382452952809152707352225090839 × (1 - 0.9576) = 761799504.7149854126556426490761064573137`

## 4. 계산 결과

| 타격 | 비치명타 | 치명타 | 기대 피해 |
|---|---:|---:|---:|
| 1타 | 78,398,428 | 235,181,683 | 228,534,073 |
| 2타 | 182,936,274 | 548,777,081 | 533,265,431 |
...
- 현재 원정대 레벨은 281이지만 원정대/물약 주스탯은 current-v2.4.1 고정값 +680을 사용했습니다.
