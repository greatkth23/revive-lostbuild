...
- 계산 스킬: `우레바람` 최대 홀딩
- 계산기 버전: `2.2.0`
- 파서 버전: `lostark-api-v2.2.0`
- 규칙 버전: `current-v2.2.0` — v2.1 확정 산식 + 데이터 출처 감사 수정
- DB 릴리스: `weather-artist-v0.1`
- 시나리오 프리셋: `max-favorable-example-boss-v1`
- 계산 모드: `ESTIMATE_WITH_FALLBACK`
- 규칙 출처: `current-v2.1.0 + calculator_v2.1.0_data_source_audit + explicit user corrections`
- 중간 버림 단계: `없음`
- API 원본: [봄날꽃씨_우레바람_current-v2.2.0_api_raw.json](봄날꽃씨_우레바람_current-v2.2.0_api_raw.json)
- 파싱 결과: [봄날꽃씨_우레바람_current-v2.2.0_parsed.json](봄날꽃씨_우레바람_current-v2.2.0_parsed.json)
...
| 일반 보석 회오리 걸음 피해 | `0.40` | `gems.Gems[1].Tooltip`<br>9레벨 광휘의 보석 유물 보석 아이템 레벨 1640 (티어 4) 장착중 장착, 합성, 조율 가능 아이템 레벨 1640 거래 제한 아이템 레벨 1640 캐릭터 귀속됨 \|거래 불가 보석 레벨 9 효과 [기상술사] 회오리 | 예 | 아니오 | 아니오 | 현재 계산 스킬은 우레바람 |
...
| 일반 보석 칼바람 피해 | `0.40` | `gems.Gems[2].Tooltip`<br>9레벨 광휘의 보석 유물 보석 아이템 레벨 1640 (티어 4) 장착중 장착, 합성, 조율 가능 아이템 레벨 1640 거래 제한 아이템 레벨 1640 캐릭터 귀속됨 \|거래 불가 보석 레벨 9 효과 [기상술사] 칼바람 | 예 | 아니오 | 아니오 | 현재 계산 스킬은 우레바람 |
...
| 일반 보석 몰아치기 피해 | `0.40` | `gems.Gems[4].Tooltip`<br>9레벨 광휘의 보석 유물 보석 아이템 레벨 1640 (티어 4) 장착중 장착, 합성, 조율 가능 아이템 레벨 1640 거래 제한 아이템 레벨 1640 캐릭터 귀속됨 \|거래 불가 보석 레벨 9 효과 [기상술사] 몰아치 | 예 | 아니오 | 아니오 | 현재 계산 스킬은 우레바람 |
...
| 일반 보석 바람송곳 피해 | `0.40` | `gems.Gems[5].Tooltip`<br>9레벨 광휘의 보석 유물 보석 아이템 레벨 1640 (티어 4) 장착중 장착, 합성, 조율 가능 아이템 레벨 1640 거래 제한 아이템 레벨 1640 캐릭터 귀속됨 \|거래 불가 보석 레벨 9 효과 [기상술사] 바람송 | 예 | 아니오 | 아니오 | 현재 계산 스킬은 우레바람 |
...
| 일반 보석 마주바람 피해 | `0.36` | `gems.Gems[9].Tooltip`<br>8레벨 광휘의 보석 유물 보석 아이템 레벨 1640 (티어 4) 장착중 장착, 합성, 조율 가능 아이템 레벨 1640 거래 제한 아이템 레벨 1640 캐릭터 귀속됨 \|거래 불가 보석 레벨 8 효과 [기상술사] 마주바 | 예 | 아니오 | 아니오 | 현재 계산 스킬은 우레바람 |
...
| 일반 보석 싹쓸바람 피해 | `0.36` | `gems.Gems[10].Tooltip`<br>8레벨 광휘의 보석 유물 보석 아이템 레벨 1640 (티어 4) 장착중 장착, 합성, 조율 가능 아이템 레벨 1640 거래 제한 아이템 레벨 1640 캐릭터 귀속됨 \|거래 불가 보석 레벨 8 효과 [기상술사] 싹쓸바 | 예 | 아니오 | 아니오 | 현재 계산 스킬은 우레바람 |
...
| 공간 가르기 | `3` | `arkPassive.Effects[4]`<br>깨달음 4티어 공간 가르기 Lv.3 공간 가르기 아크 패시브 레벨 3 깨달음 X키를 눌러 공간 가르기를 사용할 수 있게 되고 기본 및 여우비 상태에서 사용할 수 있다. 공간 가르기가 주는 피해가 200.0% 증가한다 | 예 | 아니오 | 아니오 | 우레바람이 아닌 다른 스킬 전용 효과 |
...
| 풀려난 힘 | `5` | `arkPassive.Effects[14]`<br>도약 1티어 풀려난 힘 Lv.5 풀려난 힘 아크 패시브 레벨 5 도약 초각성 스킬이 적에게 주는 피해가 15.0% 증가한다.\|\| | 예 | 예 | 예 | - |
...
| 단련된 가르기 | `3` | `arkPassive.Effects[17]`<br>도약 2티어 단련된 가르기 Lv.3 단련된 가르기 아크 패시브 레벨 3 도약 우레바람이 일반 조작으로 변경되고, 피해량이 75.0% 증가한다.\|\| | 예 | 예 | 예 | - |
...
| 일반 보석 우레바람 피해 | 0.0000% | 1 |

`전체 소제목 배율 = 1.24 × 1.19 × 1.17 × 1.625440 × 1.070 × 1.15 × 1.184 × 1.15 × 1.024 × 1.012 × 1.045 × 1 × 1.75 × 1 × 1.0728 × 1 = 9.5589498950611758018096015605760000000`
...
`스킬 본체 = 351.262 × 217160 (API_PROFILE) + 52,583 = 76332638.920`

`비치명타 원시값 = 76332638.920 × 1.5348 × 9.5589498950611758018096015605760000000 × 0.76 × 0.5263157894736842105263157894736842105263 = 447952787.8778995208772634983828040162384`

`floor(447952787.8778995208772634983828040162384) = 447,952,787`
...
`치명타 원시값 = 447952787.8778995208772634983828040162384 × 2.596 × 1.13680 = 1321968165.157911671165177084320239888293`

`기대 피해 원시값 = 1321968165.157911671165177084320239888293 × 0.9576 + 447952787.8778995208772634983828040162384 × (1 - 0.9576) = 1284909913.161239155992969548276492607318`

## 4. 계산 결과

- 비치명타 피해: **447,952,787**
- 치명타 피해: **1,321,968,165**
- 기대 피해: **1,284,909,913**
- 치명타율: **95.7600%**
...
| 결과 | 미적용 | 적용 | 차이 |
|---|---:|---:|---:|
| 비치명타 | 396,116,618 | 447,952,787 | +51,836,169 |
| 치명타 | 1,168,992,746 | 1,321,968,165 | +152,975,419 |
| 기대 피해 | 1,136,222,798 | 1,284,909,913 | +148,687,115 |
...
- 현재 원정대 레벨은 281이지만 원정대/물약 주스탯은 current-v2.2.0 고정값 +680을 사용했습니다.
