...
- 계산기/규칙 버전: `2.8.1` / `arcana-current-v2.8.1`
...
|---|---:|---:|---:|
| 셀레스티얼 레인 | 17,950,932.00 | 496,103,036.00 | **514,053,969.00** |
| 세렌디피티 | 19,480,551.00 | 212,027,384.00 | **231,507,935.00** |
| 시크릿 가든 | 4,743,474.00 | 350,506,094.00 | **355,249,569.00** |
| 포 카드 | 23,525,173.00 | 236,839,296.00 | **260,364,470.00** |
| 4스택 루인(공통, 트리거 보정 전) | - | 53,872,679.00 | **53,872,679.00** |
...
|---|---:|---:|---:|
| 셀레스티얼 레인 | 175,893,576.00 | 598,594,067.00 | 514,053,969.00 |
| 세렌디피티 | 38,949,870.00 | 284,716,386.00 | 231,507,935.00 |
| 시크릿 가든 | 121,555,558.00 | 413,673,071.00 | 355,249,569.00 |
| 포 카드 | 89,088,774.00 | 303,183,394.00 | 260,364,470.00 |
| 4스택 루인 | 18,687,128.00 | 63,595,297.00 | 53,872,679.00 |
...
|---|---|---:|---:|---:|
| 셀레스티얼 레인 | 비방향성 | 598,594,067.00 | 644,900,000.00 | -7.18% |
| 세렌디피티 | 헤드 실패·우연한 일격 발동·꿰뚫는 일격 미발동 | 244,370,800.00 | 267,800,000.00 | -8.75% |
| 시크릿 가든 | 백어택 성공 | 413,673,071.00 | 437,400,000.00 | -5.42% |
| 포 카드 | 백어택 성공 | 303,183,394.00 | 359,300,000.00 | -15.62% |

- 실측 `더 데빌 2,241.40백만`은 사용자 요청 범위의 모션계수·모션상수가 없어 계산 비교에서 제외했습니다.

## 2. 공격력과 공통 입력

`재구성 공격력 = 174,481.75` (API 프로필 `161,761.00`, 차이 `12,720.75`)

공식 v2.7.2 규칙을 이어받아 이후 계산에는 재구성 공격력 **174,481.75**을 사용했습니다.

- 특화 `1,646.00` → 루인 피해 `+82.41%`
- 추가 피해 배율: `×1.36`
- 일반 치명타 피해 배율: `2.05`
...
| 시크릿 가든 스킬 본체 | 2.00 | 301.00 | 349,264.49 | 4,743,474.00 |
...
- 루인 효과 전용 배율: 특화 `×1.82`, 황후의 탐욕 `×1.01`, 황후의 연회 `×1.26`, 황후의 속삭임 `×1.20`, 인피니티 덱 10P `×1.02`.
...
- 실측 비교는 우연한 일격 발동 확률을 `100.00%`, 꿰뚫는 일격 발동 확률을 `0.00%`로 고정했습니다. 루인 치명타 피해 배율은 `7.94`, 방어 배율은 `0.53`입니다.
...
- API 호출 시각(KST): `2026-08-20T17:42:29.800523+09:00`
...
|---|---:|---|
| profiles | 200 | 2026-08-20T17:42:28.454676+09:00 |
| equipment | 200 | 2026-08-20T17:42:28.589080+09:00 |
| avatars | 200 | 2026-08-20T17:42:28.693833+09:00 |
| combatSkills | 200 | 2026-08-20T17:42:28.801020+09:00 |
| engravings | 200 | 2026-08-20T17:42:28.966117+09:00 |
| cards | 200 | 2026-08-20T17:42:29.042796+09:00 |
| gems | 200 | 2026-08-20T17:42:29.254124+09:00 |
| arkPassive | 200 | 2026-08-20T17:42:29.476657+09:00 |
| arkGrid | 200 | 2026-08-20T17:42:29.585699+09:00 |
