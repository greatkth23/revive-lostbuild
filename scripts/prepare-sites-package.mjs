...
const fixture = JSON.parse(await (await import('node:fs/promises')).readFile(resolve(project, 'scripts/fixtures/weather-artist-e2e.json'), 'utf8'));
...
await writeFile(resolve(dist, 'server/data.json'), JSON.stringify({
